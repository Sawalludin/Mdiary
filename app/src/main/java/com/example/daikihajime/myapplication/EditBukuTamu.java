...
public class EditBukuTamu extends Activity {
	...
	private static final String url_pendaftaran_details = "http://192.168.1.101/mahasiswa/get_pendaftaran_details.php";

	// url untuk pembaharuan buku tamu
	private static final String url_update_pendaftaran = "http://192.168.1.101/mahasiswa/update_pendaftaran.php";

	// url untuk menghapus buku tamu
	private static final String url_delete_pendaftaran = "http://192.168.1.101/mahasiswa/delete_pendaftaran.php";
