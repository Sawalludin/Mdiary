...
public class SemuaDiari extends ListActivity {
    ...
    private static String url_semua_bukutamu = "http:/192.168.1.101/mahasiswa/get_all_pendaftaran.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_diari);
    ...
    class LoadSemuaBukuTamu extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SemuaDiari.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            SemuaDiari.this, bukutamuList,
                            R.layout.semua_diari, new String[] { TAG_PID,
                                    TAG_NAME},
                            new int[] { R.id.pid, R.id.tanggal });
